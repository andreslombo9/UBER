 ...
 * @author ANDRES
 */
public class Pago_TC implements InterfaceFW {
    private int id;
    ...
    public Pago_TC(int id, int numtarjeta, String Fexp, int Numt, String Contraseña, float Cantidad) {
        this.id = id;
    ...
    Pago_TC(int id, int numtarjeta, String Fexp, String Contraseña, float Cantidad) {
